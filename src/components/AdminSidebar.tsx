...
import { Location } from "history"; // Correct type for Location
...
const AdminSidebar = () => {
  ...
  const [data2, setData] = useState<Office[]>([]); // Type updated here
...
const DivTwo = ({ location, data2 }: DivTwoProps) => (
  <div>
    <h5>OFFICES</h5>
    <ul>
      {data2 ? data2.map((office) => (
        <Li
          key={office._id}
