...
const weeklyAttendance = [60, 55, 70, 65, 75]; // Example weekly attendance
// const officeStatusDistribution = [60, 20, 20]; // Active, On Leave, Resigned (example distribution)
    ...
    <div className="AdminContainer">
      ...
      <main>
        <div className="officeRecordsContainer">
          ...
          {/* Average Working Hours Bar Chart */}
          <div className="chartSection">
            <h2>Average Working Hours (Last 5 Days)</h2>
            <div className="chart">
              <BarChart
          ...
          {/* Employees Checked In Bar Chart */}
          <div className="chartSection">
            <h2>Employees Checked In (Last 5 Days)</h2>
            <div className="chart">
              <BarChart
          ...
          {/* Attendance Rate by Department Doughnut Chart */}
          <div className="chartSection">
            <h2>Attendance Rate by Department</h2>
            <div className="chart">
              <DoughnutChart
          ...
          {/* New Line Chart: Weekly Attendance */}
          <div className="chartSection">
          ...
          {/* New Pie Chart: Employee Status Distribution */}
          <div className="chartSection">
